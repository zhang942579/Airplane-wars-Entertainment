...
class EnemyPlane(pygame.sprite.Sprite):
    ...
    def __init__(self, screen):
        pygame.sprite.Sprite.__init__(self)
        # 5.创建一个飞机的图片
        self.image = pygame.image.load('./enemy0.png')  # 51*39
...
class EnemyBullet(pygame.sprite.Sprite):
    ...
    def __init__(self, screen, x, y):
        ...
        # 坐标
        # 图片
        self.image = pygame.image.load('./bullet1.png')  # 9*21
        self.rect = self.image.get_rect()  # rect属性：矩形
...
class GameSound(object):
    def __init__(self):
        ...
        pygame.mixer.music.load("./bg2.ogg")
        pygame.mixer.music.set_volume(0.5)  # 声音大小 一半

        self.__bomb = pygame.mixer.Sound("./bomb.wav")
...
class Bomb(object):
    ...
    def __init__(self, screen, type):
        ...
        if type == 'enemy':
            # 加载爆炸资源
            self.mImages = [
                pygame.image.load("./enemy0_down" + str(v) + ".png") for v in range(1, 5)]
        else:
            # 加载爆炸资源
            self.mImages = [pygame.image.load(
                "./hero_destroy" + str(v) + ".png") for v in range(1, 4)]
...
class Manager(object):
    ...
    def __init__(self):
        ...
        # 2创建一个背景图片
        # self.background = pygame.image.load('./sucai/background.png')
    ...
    def drawText(self, text, x, y, textHeight=30, fontColor=(255, 255, 255), backgroudColor=None):
        ...
        font_obj = pygame.font.Font('./baddf.ttf', textHeight)
